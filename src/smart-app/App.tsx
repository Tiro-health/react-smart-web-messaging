    ...
    <>
      <div className="mt-4 px-10">
        ...
        <div className="mt-2 flex justify-between items-center">
          ...
          <button
            type="button"
            className="block rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            onClick={handleSend}
          >
            Send
          </button>
